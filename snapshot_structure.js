 ...
 * 用途：掃描任意 JS/TS/Vue 專案，輸出專案結構、函式清單與依賴清單至 project_structure.md
 * 使用方式：在專案根目錄執行 `node project_structure.js`
...
function main() {
  ...
  // 輸出至 project_structure.md
  fs.writeFileSync(path.join(root, "project_structure.md"), md, "utf-8");
  console.log("已生成 project_structure.md");
}
